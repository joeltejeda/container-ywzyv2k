...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ywzyv2k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ywzyv2k.containers.anotherwebservice.com/
...
```
git clone git@github.com:joeltejeda/container-ywzyv2k.git
cd container-ywzyv2k
```
...
```
docker attach container-ywzyv2k
```
